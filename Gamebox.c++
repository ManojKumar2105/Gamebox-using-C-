...
int playQuiz(){
    ...
    cin>>c;
    if(c=='s' || c=='S'){
        cout<<"Q1. What’s the shortcut for the “copy” function on most computers"<<endl;
        ...
        cout<<"(a) Think Different (b) Dare to Leap (c) The Power to Do More (d)Never Settle"<<endl;
        cin>>option;
        if(option=='a' || option=='A'){
            score=score+1;
        }
        ...
        cout<<"(a) Sam Raimi (b) Russo Brothers (c) Taika Waititi (d) Zack Snyder"<<endl;
        cin>>option;
        if(option=='b' || option=='B'){
            score=score+1;
        }
        ...
        cout<<"(a) Blue, Black, Green, Red and Yellow  (b) Black,Violet,White,Green and Yellow (c) Blue,Brown,Gold,Red and Yellow (d) Red,Yellow,Green,Black and White "<<endl;
        cin>>option;
        if(option=='a' || option=='A'){
            score=score+1;
        }
...
void num_guess()
{
	...
	do
	{
		...
		while(true)
		{
			...
			{
				cout<<"\n\tTHE NUMBER WHICH YOU HAVE GUESSED IS GREATER THAN THE NUMBER WHICH YOU NEED TO FIND";
				guesses++;
			}
			else if(guess<random_number)
			{
				cout<<"\n\tTHE NUMBER WHICH YOU HAVE GUESSED IS LESSER THAN THE NUMBER WHICH YOU NEED TO FIND";
				guesses++;
			}
			else
			{
				cout<<"\n CONGRATULATIONS YOU HAVE FOUND THE NUMBER";
				cout<<"\n THE NUMBER OF GUESSES YOU HAVE MADE:"<<guesses;
				break;
			}
		}
